	...
	<div class="infoBox">
		...
		<div class="objectPhoto">
			...
			<div class="objectPhoto__objectFirst">
				...
				<img src= "static/img/objects/droneport/front.JPG" width = "242px" height= "242px" class="objectPhoto__img">
			...
			<div class="objectPhoto__objectSecond">
				<img src= "static/img/objects/droneport/top.JPG" width = "242px" height= "242px" class="objectPhoto__img">
					<div class="objectPhoto__button">
						<button value = "+" class = "objectPhoto__button_value" ><img src="static/img/ico/find.svg"></button>
					</div>
			</div>
			...
			<div class="objectPhoto__objectThird">
				...
				<img src= "static/img/objects/droneport/front_1.JPG" width = "242px" height= "242px" class="objectPhoto__img" >
					<div class="objectPhoto__button">
						<button value = "+" class = "objectPhoto__button_value" ><img src="static/img/ico/find.svg"></button>
					</div>
			</div> 
